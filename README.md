...
-	[`alpine` (*Dockerfile*)](https://github.com/TobiasH87Docker/rpi-nginx/blob/master/alpine.armhf.Dockerfile) ([current Version: 1.16](https://pkgs.alpinelinux.org/package/v3.11/main/armhf/nginx) on AlpineLinux)
